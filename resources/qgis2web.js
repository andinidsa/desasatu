...
map.getView().fit([12158959.349019, -833639.671243, 12164102.254152, -830285.528956], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Desa Karang Klesem</h2>';
        return titleElement;
    })(),
